...
const appImages = {
    ...
    onboarding1: require('../../../assets/images/8.png'),
    onboarding2: require('../../../assets/images/profile.png'),
    onboarding3: require('../../../assets/images/9.png'),
...
const appIcons = {
    ...
    onboardingtext: require('../../../assets/images/onboardingtext1.png'),
    onboardingtext2: require('../../../assets/images/onboardingtext2.png'),
    onboardingtext3: require('../../../assets/images/onboardingtext3.png'),
    play: require('../../../assets/icons/play.png'),
...
const appFonts = {
    ...
    MalarkeyTextRegular: 'MalarkeyRegular',
    LatoTextBold: 'Lato-Bold',
    RedHatDisplayTextMedium:'RedHatDisplay-Medium',
    RedHatDisplayTextSemiBold:'RedHatDisplay-SemiBold',
    RedHatDisplayTextBold:'RedHatDisplay-Bold',
    KulimTextItalic: 'KulimPark-Italic',
    KulimTextMedium: 'KulimPark-Medium',
