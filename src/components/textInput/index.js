...
function Colored({
  ...
  fullWidth, // New prop to control full width behavior
}) {
  return (
    <TouchableOpacity
      activeOpacity={1}
      ...
      disabled={!onPress}
      style={[
        // Conditionally apply margins based on fullWidth prop
        fullWidth
          ? {width: '100%'}
      ...
      {title ? (
        <Wrapper style={{marginHorizontal: 0}}>
          <Text isInputTitle style={[{marginBottom: 10}, titleStyle]}>
            {title}
          </Text>
          <Spacer isTiny />
        </Wrapper>
      ...
      <Wrapper
        style={[
          appStyles.inputContainerColored,
          {
            ...
            marginHorizontal: 0,
            // Ensure input container takes full width when needed
