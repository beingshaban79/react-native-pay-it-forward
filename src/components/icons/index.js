...
export function Custom({ icon, size, animation, style, duration, color, onPress, containerStyle }) {
        ...
        <Wrapper animation={animation} duration={duration} style={containerStyle}>
            <TouchableOpacity disabled={!onPress} onPress={onPress}>
                <Image
                    ...
                    resizeMode="contain"
                    style={[
                        { height: size ? size : defaultSize, width: size ? size : defaultSize, tintColor: color },
                        style
                    ]}
                />
            </TouchableOpacity>
